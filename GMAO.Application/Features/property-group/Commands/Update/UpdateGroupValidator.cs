...
{
    public class UpdateGroupValidator : AbstractValidator<UpdateGroupPropertyCommand>
    {
        public UpdateGroupValidator()
        {
            ...
            this.RuleFor(x => x.HeadquartersAddress)
                .SetValidator(validator: new AddressValidator()).When(x => x.HeadquartersAddress != null);
