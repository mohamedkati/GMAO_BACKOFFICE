...
namespace GMAO.Shared.Templates
{
    public static class AuthEmailTemplateHelper
    {
        public static string GetResetPasswordEmailContent(string username, string url)
        {
            var body = $@"<style>
					html,
					body {{
        ...
        public static string GetConfirmationEmailContent(string username, string url)
        {
            var body = $@"<style>
					html,
					body {{
        ...
        public static string GetAccountCreatedEmailContent(string username, string password, string url)
        {
            var body = $@"<style>
					html,
					body {{
								...
								<td align=""left"" valign=""center"">
									<div
										...
										<div style=""padding-bottom: 30px; font-size: 17px;"">
											...
											<span>Welcome to our university!</span><br/><br/>


											<strong>Your password is : </strong> <span>{password}</span>

										</div>
										<div style=""padding-bottom: 30px"">You have been invited to join the 'NAME OF UNIVERSITY' team
											from
											<a href=""support@keenthemes.com"" rel=""noopener"" target=""_blank""
												style=""text-decoration:none;color: #009EF7"">name@university.com</a>. To get started,
										...
										<div style=""padding-bottom: 30px"">Joining the team will give you access to the team's dashboard,
